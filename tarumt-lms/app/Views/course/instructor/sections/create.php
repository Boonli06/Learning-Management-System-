...
<form id="sectionForm" method="POST" action="/instructor/sections/create" class="space-y-6">
    <!-- Basic Information -->
    <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-medium text-gray-900">Basic Information</h3>
            <p class="text-sm text-gray-500 mt-1">Provide the essential details for your section</p>
        </div>
        <div class="p-6 space-y-6">
                ...
                >
                    ...
                    <?php foreach ($courses as $course): ?>
                        <option value="<?= $course['id'] ?>" 
                                <?= (($_SESSION['old_input']['course_id'] ?? '') == $course['id']) ? 'selected' : '' ?>>
            ...
            <div>
                ...
                <input 
                    ...
                    id="order" 
                    name="order" 
                    value="<?= htmlspecialchars($_SESSION['old_input']['order'] ?? '1') ?>"
                    min="1" 
                    max="999"
                    required
                    class="block w-full px-3 py-2 border border-gray-300 rounded-lg text-sm placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-black focus:border-black"
            ...
            <div>
                ...
                >
                    <?php foreach ($statusOptions as $value => $label): ?>
                        <option value="<?= $value ?>" <?= (($_SESSION['old_input']['status'] ?? 'active') === $value) ? 'selected' : '' ?>>
                            <?= $label ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="flex items-center justify-between">
                ...
                <label class="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" id="is_preview" name="is_preview" value="1" 
                           <?= (isset($_SESSION['old_input']['is_preview']) && $_SESSION['old_input']['is_preview']) ? 'checked' : '' ?>
                           class="sr-only peer">
