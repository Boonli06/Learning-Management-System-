            ...
            <div class="flex flex-col w-64">
                <div class="flex flex-col flex-grow pt-5 pb-4 overflow-y-auto bg-black sidebar-scrollbar">
                    ...
                    <nav class="mt-5 flex-1 px-2 space-y-1">
                        <!-- Dashboard -->
                        <a href="/student/dashboard" class="<?= (isset($currentPage) && $currentPage === 'dashboard') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> group flex items-center px-2 py-2 text-sm font-medium rounded-lg transition-colors duration-200">
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="/courses" class="<?= (isset($currentPage) && $currentPage === 'browse-courses') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> group flex items-center px-2 py-2 text-sm font-medium rounded-lg transition-colors duration-200">
                                <i class="fas fa-search mr-3 text-sm"></i>
                                Browse Courses
                            </a>
                            <a href="/student/my-courses" class="<?= (isset($currentPage) && $currentPage === 'my-courses') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> group flex items-center px-2 py-2 text-sm font-medium rounded-lg transition-colors duration-200">
                                <i class="fas fa-book mr-3 text-sm"></i>
                                My Courses
                            </a>
                            <a href="/student/wishlist" class="<?= (isset($currentPage) && $currentPage === 'wishlist') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> group flex items-center px-2 py-2 text-sm font-medium rounded-lg transition-colors duration-200">
                                <i class="fas fa-heart mr-3 text-sm"></i>
                                Wishlist
                            </a>
                            <a href="/student/progress" class="<?= (isset($currentPage) && $currentPage === 'progress') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> group flex items-center px-2 py-2 text-sm font-medium rounded-lg transition-colors duration-200">
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="/cart" class="<?= (isset($currentPage) && $currentPage === 'cart') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> group flex items-center px-2 py-2 text-sm font-medium rounded-lg transition-colors duration-200">
                    ...
                    <div class="flex-shrink-0 px-4 py-4 border-t border-gray-700">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <img class="h-8 w-8 rounded-full" src="<?= $_SESSION['user']['avatar'] ?? 'https://ui-avatars.com/api/?name=Student&background=ffffff&color=000000' ?>" alt="Profile">
                            </div>
        ...
        <div class="flex flex-col w-0 flex-1 overflow-hidden">
            ...
            <div class="relative z-10 flex-shrink-0 flex h-16 bg-white shadow border-b border-gray-200">
                ...
                <div class="flex-1 px-4 flex items-center">
                    <div class="max-w-lg w-full">
                        <div class="relative">
                            ...
                            <input type="text" placeholder="Search courses..." class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-black focus:border-black text-sm">
                        </div>
                    </div>
                </div>
                ...
                <div class="ml-4 flex items-center md:ml-6 space-x-3">
                    <!-- Cart -->
                    <a href="/cart" class="bg-white p-2 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black relative">
