                ...
                <div class="flex flex-col flex-grow pt-5 pb-4 overflow-y-auto bg-black sidebar-scrollbar">
                    ...
                    <nav class="mt-5 flex-1 px-2 space-y-1">
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="/student/browse" class="<?= (isset($currentPage) && $currentPage === 'browse-courses') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> group flex items-center px-2 py-2 text-sm font-medium rounded-lg transition-colors duration-200">
                                <i class="fas fa-search mr-3 text-sm"></i>
                                Browse Courses
                            </a>
                            <a href="/student/dashboard/mycourses" class="<?= (isset($currentPage) && $currentPage === 'my-courses') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> group flex items-center px-2 py-2 text-sm font-medium rounded-lg transition-colors duration-200">
