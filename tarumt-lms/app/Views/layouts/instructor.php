            ...
            <div class="flex flex-col w-64">
                <div class="flex flex-col flex-grow pt-5 pb-4 overflow-y-auto bg-black sidebar-scrollbar">
                    ...
                    <nav class="mt-5 flex-1 px-2 space-y-1">
                        <!-- Dashboard -->
                        <a href="/instructor/dashboard" class="<?= (isset($currentPage) && $currentPage === 'dashboard') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> group flex items-center px-2 py-2 text-sm font-medium rounded-lg transition-colors duration-200">
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="/instructor/students" class="<?= (isset($currentPage) && $currentPage === 'students') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> group flex items-center px-2 py-2 text-sm font-medium rounded-lg transition-colors duration-200">
                    ...
                    <div class="flex items-center">
                        <nav class="flex" aria-label="Breadcrumb">
                            <ol class="flex items-center space-x-4">
                                <li>
                                    <div>
                                        <a href="/instructor/dashboard" class="text-gray-400 hover:text-gray-500">
